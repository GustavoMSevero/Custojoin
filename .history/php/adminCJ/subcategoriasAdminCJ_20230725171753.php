...
switch ($option) {
    ...
    case 'update subcategory':
        ...
        $updateSubcategory=$pdo->prepare("UPDATE subcategoria SET codeCategoria=:codeCategoria, codeSubcategory=:codeSubcategory, subcategory=:subcategory 
                                            WHERE idsubcategory=:idsubcategory");
        $updateSubcategory->bindValue(":codeCategoria", $codegroup);
        $updateSubcategory->bindValue(":codeSubcategory", $codeCategory);

        $updateSubcategory->bindValue(":subcategory", $subcategory);
        $updateSubcategory->bindValue(":idsubcategory", $idsubcategory);
