...
switch ($option) {
    ...
    case 'update subcategory':
        ...
        $idsubcategory = $data->idsubcategory; // 79
        ...
        $updateSubcategory=$pdo->prepare("UPDATE categoria SET codegroup=:codegroup, codecategory=:codecategory, categoryname=:categoryname 
                                            WHERE idcategory=:idcategory");
        $updateSubcategory->bindValue(":codegroup", $codegroup);
        $updateSubcategory->bindValue(":codecategory", $codecategory);
        $updateSubcategory->bindValue(":categoryname", $categoryname);
        $updateSubcategory->bindValue(":idcategory", $idcategory);
