...
switch ($option) {
    ...
    case 'update subcategory':
        ...
        $updateSubcategory=$pdo->prepare("UPDATE subcategoria SET codeCategoria=:codeCategoria, codeSubcategory=:codeSubcategory, subcategoria=:subcategory 
                                            WHERE idsubcategoria=:idsubcategory");
        ...
        $updateSubcategory->bindValue(":idsubcategoria", $idsubcategory);
